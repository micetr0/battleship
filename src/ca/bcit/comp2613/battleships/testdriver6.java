...
public class testdriver6 {
	...
	public static void main(String[] args) throws ConfigurationException {
		...
		propertiesConfiguration.load(TestDriver.class
				.getResourceAsStream("ship_info.properties"));
		log.info("Boardsize is "
				+ propertiesConfiguration.getString("boardSize1"));
		...
		try {
			FileUtils.writeStringToFile(new File("sortedShip.txt"),
					ShipUtil.shipIDorder());
		...
		// ArrayList<Ship> shipSearch = ShipUtil.findShipByPosition(listOfShip,
		// 100);
		// ArrayList<Ship> shipEndurance =
		// ShipUtil.findShipByEndurance(listOfShip, 2);
		ArrayList<Ship> shipSearchRegexX = ShipUtil.findShipByPositionRegexX(
				listOfShip, "5");
		...
		ArrayList<Marker> markerSearch = MarkerUtil.findMarkerByPositionX(
				listOfMarker, 6);
		// System.out.println("find by position x: " + markerSearch);
		log.info("find by position x: " + markerSearch);
		ArrayList<Marker> markerSearchRegex = MarkerUtil
				.findMarkerByPositionXRegex(listOfMarker, "10");
